...
void Quad::Load(int index)
{
	...
	vertex list[] =
	{
		...
		{-0.50f,-0.5f, 0.0f,	-0.32f,-0.11f, 0.0f,	0,0,0,	0,1,0},
		{-0.50f, 0.5f, 0.0f,	-0.11f, 0.78f, 0.0f,	1,1,0,	0,1,1},
		{ 0.50f,-0.5f, 0.0f,	 0.75f,-0.73f, 0.0f,	0,0,1,	1,0,0},
		{ 0.50f, 0.5f, 0.0f,	 0.88f, 0.77f, 0.0f,	1,1,1,	0,0,1}
	};
	vertex list_2[] =
	{
		...
		{0.90f,  0.25f, 0.0f,	0.90f,  0.25f, 0.0f, 	0,0,0,  1,1,1}*/
		{-0.50f,-0.5f, 0.0f,	-0.32f,-0.11f, 0.0f,	0,0,0,	0,1,0},
		{-0.50f, 0.5f, 0.0f,	-0.11f, 0.78f, 0.0f,	1,1,0,	1,1,0},
		{ 0.75f,-0.5f, 0.0f,	 0.75f,-0.90f, 0.0f,	0,0,1,	1,0,0},
		{-0.50f,-0.5f, 0.0f,	 0.75f, 0.95f, 0.0f,	0,0,0,	0,0,1}
	};
	vertex list_3[] = 
	{
